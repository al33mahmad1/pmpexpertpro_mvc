...
<link rel="stylesheet" href="<?=URLROOT?>/public/custom_css/assessment/assessment.css">
  ...
  <div class="content-wrapper">
    ...
    <div class="row mx-2 mb-2">
      <div class="col-12">
      <button class="btn btn-dark btn-sm float-right" id="add_assessment_show_modal_btn">Add new Exam</button>
      </div><!-- /.col -->
    </div>
    <?php endif;?>
        ...
        <div class="modal-body" id="map_content" style="width: 100%;">
            <div class="row py-4 justify-content-center">
                <div class="col-md-8">
                    ...
                    <p class="text-center text-success mt-3 font-menu" id="invalidPromoCode_error_text">You've not taken this exam yet</p>
                    <button type="button" id="first_time_test_button_start_btn" class="btn btn-success btn-sm btn-block mt-5 shadow">Start Exam</button>
                </div>
            </div>
        </div>
      </div>
        ...
        <div class="modal-body" style="width: 100%;">
            <div class="row py-4 justify-content-center">
                <div class="col-md-8">
                    ...
                    <p class="text-center text-success mt-3 font-menu" id="invalidPromoCode_error_text">You've taken this Exam</p>
                    ...
                    <button type="button" id="second_time_test_button_start_btn" class="btn btn-success btn-sm btn-block mt-2 shadow" data-dismiss="modal">Redo Exam</button>
                </div>
            </div>
        </div>
      </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><i class="nav-icon fas fa-plus"></i> &nbsp;&nbsp; Add Exam</h5>
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="input-group mb-3">
                  ...
                  <input type="text" id="assessment_name" class="form-control" placeholder="Exam Name">
              </div>
              ...
              <div class="input-group mb-3">
                  <button id="add_assessment_btn" class="btn btn-dark rounded form-control"><span id="add_res_show_hide_text" class="show">Add Exam</span><span id="loading_show_hide_text" class="hide"><i class="fas fa-cog fa-spin"></i> Processing Request <span class="loader__dot">. </span><span class="loader__dot">. </span><span class="loader__dot">.</span></span></button>
              </div>
          </div>
        </div>
        </div>
