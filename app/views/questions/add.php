  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 font-poppins">Add Question</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card card-white elevation-5 mb-5">
                ...
                <div class="row">
                            ...
                            <select id="assessment_id" class="form-control select2bs4">
                                <?php if(isset($data['assessments']) && $data['assessments']):?>
                                    <?php foreach($data['assessments'] as $assessment):?>
                                        <option value="<?php echo $assessment['assessment_id']?> "<?php echo (isset($data['data']['country']) && $data['data']['country']=="Afghanistan")?"selected":"";?>><?=$assessment['assessment_name']?></option>
                                    <?php endforeach;?>
                                <?php endif;?>
                            </select>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <?php if(isset($data['sections']) && $data['sections']):?>
                                    <?php foreach($data['sections'] as $section):?>
                                        <option value="<?php echo $section['section_id']?> "<?php echo (isset($data['data']['sectionId']) && $data['data']['sectionId']=="")?"selected":"";?>><?=ucfirst($section['section_name'])?></option>
                                    <?php endforeach;?>
                                <?php endif;?>
                            </select>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" id="question_statement" name="questionStatement" rows="3"></textarea>
                        </div>
                        <br>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="option_a" class="form-control" placeholder="Option A" value="<?php echo (isset($data['data']['city']))? $data['data']['city'] : "" ; ?>">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="option_b" class="form-control" placeholder="Option B" value="<?php echo (isset($data['data']['city']))? $data['data']['city'] : "" ; ?>">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="option_c" class="form-control" placeholder="Option C" value="<?php echo (isset($data['data']['city']))? $data['data']['city'] : "" ; ?>">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="option_d" class="form-control" placeholder="Option D" value="<?php echo (isset($data['data']['city']))? $data['data']['city'] : "" ; ?>">
                        </div>
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" id="question_reasoning" name="questionReasoning" rows="3"></textarea>
                        </div>
                        <br>
                ...
                <button id="add_question_btn" class="btn btn-dark float-right">Add Question</button>
                </div>
            </div>
            </div>
        </div>
...
<script type="module" src="<?=URLROOT?>/public/custom_js/question/addQuestion.js"></script>
