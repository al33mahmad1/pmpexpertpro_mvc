...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="card-header text-center">
      <p class="h3"><b>Scrum Account for $29</p>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Membership Details</p>
      
      <div class="text-center text-muted">
        <p>Please provide me access to PMP Expert Pro Scrum module for just $29.</p>
...
<script src="<?=URLROOT?>/public/custom_js/paypal/scrum.js"></script>
