...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="card-header text-center">
      <p class="h3"><b>Agile Premium Account for $49</p>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Membership Details</p>
      
      <div class="text-center text-muted">
        <p>Please provide me access to PMP Expert Pro Agile Premium module for just $49.</p>
...
<script src="<?=URLROOT?>/public/custom_js/paypal/agilePremium.js"></script>
