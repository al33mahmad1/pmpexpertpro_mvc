...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="card-header text-center">
      <p class="h3"><b>Agile & Scrum Account for $59</p>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Membership Details</p>
      
      <div class="text-center text-muted">
        <p>Please provide me access to PMP Expert Pro Agile & Scrum modules for just $59.</p>
...
<script src="<?=URLROOT?>/public/custom_js/paypal/agileAndScrum.js"></script>
